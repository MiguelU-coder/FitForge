...
/* ─────────────────────────────── */
const EditOrganization: React.FC<{ session?: any }> = ({ session }) => {
  const { id } = useParams();
  ...
  // ── Update form location when country/city changes ──
  useEffect(() => {
    if (selectedCountry && selectedCity) {
      setForm(p => ({ ...p, location: `${selectedCity}, ${selectedCountry}` }));
    ...
    axios
      ...
      .then(({ data }) => {
        ...
        setForm(p => ({
          ...
          planId: o.planId || p.planId,
          logoUrl: o.logoUrl || "https://i.pravatar.cc/150?u=gym",
        }));
      })
  ...
  // ── Submit → calls patch on the backend ──
  ...
  // ── Success screen (removed for Edit) ──
  if (stripeResult) {
    return (
      <div
        ...
        >
          ...
          <div>
            ...
            >
              ...
              has been onboarded. Use the link below to complete the subscription.
            </p>
          </div>
          ...
          <div style={{ display: "flex", gap: "12px", width: "100%" }}>
             <button
                onClick={() => {
                  const text = `Hi ${stripeResult.orgName}, here is your secure Stripe Checkout link to activate your organization on FitForge: ${stripeResult.checkoutUrl}`;
            ...
            <>
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "center", padding: "18px 0" }}>
                  <div style={{ width: "155px", display: "flex", alignItems: "center", gap: "9px", flexShrink: 0 }}>
                    <Globe size={14} style={{ color: "#475569" }} />
                    <span style={{ fontSize: "13px", fontWeight: 600, color: "#94a3b8" }}>Country</span>
                  </div>
                  <CustomSelect
                ...
                <div style={{ display: "flex", alignItems: "center", padding: "18px 0" }}>
                  <div style={{ width: "155px", display: "flex", alignItems: "center", gap: "9px", flexShrink: 0 }}>
                    ...
                    <span style={{ fontSize: "13px", fontWeight: 600, color: "#94a3b8" }}>City</span>
                  </div>
                  <CustomSelect
                    value={selectedCity}
