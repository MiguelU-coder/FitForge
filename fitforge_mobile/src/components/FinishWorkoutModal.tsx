...
const RPE_CONFIG: Record<number, { label: string; sublabel: string; color: string }> = {
  ...
  10: { label: 'ESFUERZO MÁXIMO', sublabel: 'Todo al máximo',     color: '#DC2626' },
};

// Stats config
const STAT_CONFIG = [
  { key: 'duration', icon: 'time-outline',    color: '#0EA5E9', label: 'DURACIÓN'  },
  { key: 'tonnage',  icon: 'barbell-outline',  color: '#F59E0B', label: 'VOLUMEN'   },
...
export default function FinishWorkoutModal({
  ...
  const stats = useMemo(() => {
    if (!session) return { sets: 0, tonnage: 0 };
      ...
      <View style={styles.overlay}>
        ...
        <View style={[styles.sheet, { paddingBottom: insets.bottom + 16 }]}>
          ...
          >
            ...
            >
              <View style={[styles.trophyRing, { borderColor: `${cfg.color}40` }]}>
                <LinearGradient
            ...
            <View style={styles.rpeSection}>
              ...
              <View style={styles.rpeDisplay}>
                <Text style={[styles.rpeNumber, { color: cfg.color }]}>{rpe}</Text>
                <View style={styles.rpeTextBlock}>
                  <Text style={[styles.rpeMainLabel, { color: cfg.color }]}>{cfg.label}</Text>
                    ...
                    return (
                      ...
                      >
                        <Text
                          style={[
                            styles.rpeBtnNumber,
                            isActive && { color: btnCfg.color, fontFamily: 'DMSans-Bold' },
                        ...
                        {isActive && (
                          <View style={[styles.rpeBtnDot, { backgroundColor: btnCfg.color }]} />
                        )}
                      </Pressable>
                    );
                  })}
            ...
            <View style={styles.footer}>
                ...
                >
                  {isSubmitting ? (
                    ...
                    <>
                      ...
                      <Text style={styles.confirmBtnText}>FINALIZAR ENTRENAMIENTO</Text>
                    </>
                  )}
                </LinearGradient>
              </Pressable>
              ...
              >
                ...
                <Text style={styles.cancelBtnText}>Volver al entrenamiento</Text>
              </Pressable>
            </View>
