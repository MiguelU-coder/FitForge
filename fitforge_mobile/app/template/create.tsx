...
export default function CreateTemplateScreen() {
  ...
  const handleSave = async () => {
    if (!routineName.trim() || !programName.trim()) {
      setError(
        "El nombre de la rutina y el grupo del programa son obligatorios",
      );
      return;
    }
    setError("");
  ...
  const isFormValid =
    routineName.trim().length > 0 && programName.trim().length > 0;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.sectionLabel}>INFORMACIÓN DE LA RUTINA</Text>
        ...
        <View style={styles.fieldGroup}>
          ...
          <View
            style={[
              styles.inputWrap,
              routineName.length > 0 && styles.inputWrapFocused,
            ]}
          >
            <TextInput
              style={styles.input}
        ...
        <View style={styles.fieldGroup}>
          <View style={styles.fieldLabelRow}>
            ...
            <Text style={styles.fieldLabel}>Grupo del programa</Text>
            <Text style={styles.requiredBadge}>obligatorio</Text>
          </View>
          <Text style={styles.fieldHint}>
            Las rutinas se organizan en grupos de programas
          </Text>
          <View
            style={[
              styles.inputWrap,
              programName.length > 0 && styles.inputWrapFocused,
            ]}
          >
            <TextInput
              style={styles.input}
              placeholder="e.g. Hipertrofia Mesociclo 1"
              placeholderTextColor={Colors.textMuted}
              value={programName}
              onChangeText={(t) => {
                setProgramName(t);
        ...
        <Text style={styles.sectionHint}>
          Opcional — ayuda a adaptar las recomendaciones
        </Text>
        ...
        <View style={styles.fieldGroup}>
          <View style={styles.fieldLabelRow}>
            ...
            <Text style={styles.fieldLabel}>Descripción del objetivo</Text>
          </View>
        ...
        <Text style={styles.sectionHint}>
          Añade ejercicios a tu rutina (opcional)
        </Text>
            ...
            {isLoading ? (
              ...
              <>
                ...
                <Text
                  style={[
                    styles.saveBtnText,
                    !isFormValid && styles.saveBtnTextDisabled,
                  ]}
                >
                  CREAR RUTINA
                </Text>
        ...
        <Text style={styles.saveHint}>
          Puedes añadir ejercicios a tu rutina después de crearla.
        </Text>
      </ScrollView>
