  ...
  days: [
      ...
      slots: [
        {
          ...
          muscleTarget: 'leg_press',
          sets: 3,
          repsMin: 6,
          repsMax: 8,
          isHeavy: true,
          restSeconds: REST_SECONDS.BEGINNER,
          notes: 'Leg Press / Hack Squat',
        },
        {
        ...
        },
        {
          ...
          muscleTarget: 'lateral',
          sets: 2,
          repsMin: 12,
          repsMax: 15,
          restSeconds: REST_SECONDS.ISOLATION_SHORT,
          notes: 'Lateral Raise',
        },
        {
    ...
    },
    {
      ...
      slots: [
        ...
        {
          movementPattern: 'PUSH_HORIZONTAL',
          muscleTarget: 'incline',
          sets: 3,
          repsMin: 8,
          repsMax: 10,
          restSeconds: REST_SECONDS.BEGINNER,
          notes: 'Incline DB Press',
        },
        {
        ...
        },
        {
          ...
          repsMin: 10,
          repsMax: 12,
          restSeconds: REST_SECONDS.PPL_ACCESSORY,
          notes: 'Leg Press',
        },
        {
          movementPattern: 'PULL_HORIZONTAL',
          muscleTarget: 'face_pull',
          sets: 2,
          repsMin: 12,
          repsMax: 15,
          restSeconds: REST_SECONDS.ISOLATION_SHORT,
      ...
      slots: [
        {
          ...
          repsMax: 8,
          isHeavy: true,
          restSeconds: REST_SECONDS.MEDIUM,
          notes: 'Machine Chest Press',
        },
        {
          movementPattern: 'PULL_HORIZONTAL',
  ...
  days: [
    ...
    },
    {
      ...
      slots: [
        ...
        {
          movementPattern: null,
          muscleTarget: 'hamstring_isolation',
          sets: 3,
          repsMin: 10,
          repsMax: 12,
          restSeconds: REST_SECONDS.ISOLATION_SHORT,
  ...
  days: [
      ...
      slots: [
        {
          ...
          repsMax: 8,
          isHeavy: true,
          restSeconds: REST_SECONDS.ADVANCED_COMPOUND,
          notes: 'Machine Chest Press',
        },
        {
          movementPattern: 'PUSH_HORIZONTAL',
        ...
        },
        {
          ...
          repsMin: 12,
          repsMax: 15,
          restSeconds: REST_SECONDS.ADVANCED_ISOLATION,
          notes: 'Lateral Raise',
        },
        {
          movementPattern: null,
    ...
    },
    {
      ...
      slots: [
        ...
        {
          movementPattern: 'PULL_HORIZONTAL',
          muscleTarget: 'chest_supported_row',
          sets: 3,
          repsMin: 10,
          repsMax: 12,
          restSeconds: REST_SECONDS.ADVANCED_COMPOUND,
          notes: 'Chest Supported Row',
        },
        {
          movementPattern: 'PULL_HORIZONTAL',
          muscleTarget: 'face_pull',
